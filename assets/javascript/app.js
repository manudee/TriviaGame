...
$('<br><button id="submit" name="submit">Submit</button><br>').addClass("submit btn btn-primary btn-lg col-md-offset-5 game").appendTo('body');
 
$("body").on("click", ".submit", checkAnswer);
...
function displayStats(){
                ...
                stopGame();
                $("#triviaTime").hide();
$('<br><button id="reset" name="reset">Reset</button><br>').addClass("reset btn btn-primary btn-lg col-md-offset-5").appendTo('body');
